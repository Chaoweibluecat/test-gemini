            ...
            for style in style_images:
                ...
                try:
                    ...
                    count_response = client.models.count_tokens(
                        model=model_name,
                        contents=["Fusion these images while keeping the cat clearly visible", cat_file, style_file]
                    )
                    
                    # 2. 实际生成
                    response = generate_with_retry(
                        "Fusion these images while keeping the cat clearly visible",
                        ...
                        for part in candidate.content.parts:
                            if part.inline_data:
                                ...
                                output_path = os.path.join(output_dir, 
                                    f"{cat['name']}_{style.split('.')[0]}_{i}.png")
